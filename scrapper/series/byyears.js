...
async function getSeriesByYears(yearsid, page = 1) {
    try{
        let url = `${process.env.LK21_BASE_SERIES}year/${yearsid}`;
        if (page > 1){
            url = `${process.env.LK21_BASE_SERIES}year/${yearsid}/page/${page}/`;
        }
